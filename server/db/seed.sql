...
INSERT INTO products (code, name, category, unit, default_supply_rate, default_install_rate, notes, active) VALUES
  ('WALL_R1.5',       'R1.5 external wall batts',                    'external_wall',  'm2',  6.50, 4.50, 'Lightweight or brick-veneer framed wall',                 1),
  ('WALL_R2.0',       'R2.0 external wall batts',                    'external_wall',  'm2',  7.50, 4.50, 'Most common external wall batt',                          1),
  ('WALL_R2.5',       'R2.5 external wall batts',                    'external_wall',  'm2',  9.00, 5.00, 'Higher-performance external wall',                        1),
  ('GARAGE_WALL_R2.0','R2.0 garage common-wall batts',              'garage_wall',    'm2',  7.50, 4.50, 'Garage-to-house internal wall',                           1),
  ('CEIL_R3.5',       'R3.5 ceiling batts',                          'ceiling',        'm2',  6.00, 4.00, 'Standard ceiling',                                        1),
  ('CEIL_R4.0',       'R4.0 ceiling batts',                          'ceiling',        'm2',  7.00, 4.00, 'Higher-performance ceiling',                              1),
  ('CEIL_R5.0',       'R5.0 ceiling batts',                          'ceiling',        'm2',  8.50, 4.50, 'Colder-climate ceiling',                                  1),
  ('CEIL_OUT_R1.5',   'R1.5 outdoor-living / alfresco ceiling batts','ceiling_outdoor','m2',  6.00, 5.00, 'Alfresco / outdoor living ceiling',                       1),
